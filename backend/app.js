...
const { getIndianStocks, getUSStocks, addIndianStock, updateIndianStock, updateUSStock, addUSStock, deleteIndianStock, deleteUSStock, getStocksByPriority } = require('./stocks/stockController');
...
app.put('/api/stocks/indian/:id', updateIndianStock); // New route to update an Indian stock
app.put('/api/stocks/us/:id', updateUSStock); // New route to update a US stock
